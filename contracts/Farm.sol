...
contract Farm is StakingRewards, Ownable, ERC721Holder {
    ...
    mapping(address => string) public pool_names;
    ...
    function set_pool_name(address pool, string memory pool_name) public {
        require(pool == msg.sender, "permission denied");
        pool_names[pool] = pool_name;
    }
